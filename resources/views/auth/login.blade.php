                ...
                <div>
                    <a href="{{ route('login.google') }}"
                        ...
                        <svg class="h-5 w-5 text-red-500" fill="currentColor" viewBox="0 0 24 24">
                            <!-- Ikon Google -->
                            <path
                                d="M12.24 10.285V14.4h6.806c-.275 1.765-2.056 5.174-6.806 5.174-4.095 0-7.439-3.389-7.439-7.574s3.345-7.574 7.439-7.574c2.33 0 3.891.989 4.785 1.849l3.254-3.147C18.189 1.186 15.479 0 12.24 0 5.478 0 .803 4.582.803 10.285c0 5.703 4.674 10.285 10.637 10.285 6.106 0 11.057-5.14 11.057-11.032H12.24z" />
                        </svg>
                    </a>
                </div>
